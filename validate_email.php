...
if ($result->num_rows > 0) {
    ...
    $resetLink = "http://yourwebsite.com/reset_password.php?token=$token"; // Adjust the URL to your reset password page

    // Send the email
    $to = $email;
    $subject = "Password Reset";
    $message = "To reset your password, click on this link: " . $resetLink;
    $headers = "From: no-reply@yourwebsite.com"; // Adjust the From address to your domain
